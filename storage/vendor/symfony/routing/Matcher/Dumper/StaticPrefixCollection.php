...
class StaticPrefixCollection
{
    ...
    /**
     * Detects whether there's a login prefix relative to the group prefix and returns it.
     *
     * @param string $prefix
     * @param string $anotherPrefix
     *
     * @return false|string A login prefix, longer than the base/group prefix, or false when none available
     */
