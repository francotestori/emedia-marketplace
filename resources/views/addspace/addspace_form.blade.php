    ...
    <div class="row">
        <div class="col-lg-12">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-lg-6">
                            <a href="{{URL::previous()}}" class="btn btn-default pull-right">{{Lang::get('messages.cancel')}}</a>
                        </div>
                        <div class="col-lg-6">
                            {{Form::submit(Lang::get('messages.create'), ['class' => 'btn btn-info pull-left'])}}
                        </div>
                    </div>
                </div>
                {{Form::close()}}
        ...
        <div class="col-lg-12">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            {{Form::submit(Lang::get('messages.update'), ['class' => 'btn btn-info pull-left'])}}
                        </div>
                    </div>
                </div>
                {{Form::close()}}
