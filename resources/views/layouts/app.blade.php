            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <!--<li><a href="{{url('/wallet')}}">{{Lang::get('messages.wallet')}}</a></li>-->
                    </ul>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @guest
                            <li><a href="{{ route('login') }}">{{Lang::get('messages.login')}}</a></li>
                            <li><a href="{{ route('register') }}">{{Lang::get('messages.register')}}</a></li>
                        @else
                            <li class="dropdown">
