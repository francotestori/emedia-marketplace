...
<table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr>
        <td><img src="{{asset('img/mail/welcome-header.png')}}" width="600" height="288" alt="¡Bienvenido a Emedia Market!" style="background-color:#29abe2; color:#fff; font-weight:3em; font-weight:800" /></td>
    </tr>
    <tr>
        <td height="291" align="center" bgcolor="#29abe1">
            ...
            <p  style="font-size: 18px;font-family: Arial; color: rgb(236, 236, 236); padding-left: 5%; padding-right: 5%;">{{Lang::get('mail.welcome.what')}}</p>
            <br />
    ...
    <tr>
        <td height="115" align="center">
            <p style="font-size: 14px; font-family: Arial; padding-left: 5%; padding-right: 5%;">{{Lang::get('mail.welcome.doubt')}}<br />
